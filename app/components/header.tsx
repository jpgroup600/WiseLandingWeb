...
export default function Header() {
  return (
    ...
    <div className='w-full h-auto flex flex-col md:flex-row'>
        ...
        {/* form div */}
        <div className=' md:w-[40%] w-full h-[515px] md:h-[750px]'>
          {/* main div */}
          <div className="h-full w-full bg-red-50 flex items-center justify-center">
          <div className="w-[80%] h-[415px] md:h-[650px] rounded-2xl bg-[#150f96] flex flex-col items-center">
            ...
            <div className="w-[90%] mt-6"><Header_Form/></div>
          </div>
          </div>
        </div>
    </div>
