...
export default function Header() {
  return (
    <>
    <div className='w-full h-auto gap-4 flex flex-col md:flex-row md:px-20'>
        {/* text and image div */}
        ...
        <div className=' md:w-[40%] hidden md:block w-full h-[715px] md:h-[750px]'>
          ...
          <div className="w-[65%] h-[650px] md:h-[650px] rounded-2xl bg-[#150f96] flex flex-col items-center">
